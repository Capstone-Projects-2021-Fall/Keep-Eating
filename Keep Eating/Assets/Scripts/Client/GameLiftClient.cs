...
public class GameLiftClient
{
    ...
    private string FleetId = "fleet-517f0108-fb79-484d-9688-6fd1415a64d6"; // TODO: probably don't hardcode this, use alias or something
    ...
    async private void setup()
    {
        ...
        _badNetworkClient = GameObject.FindObjectOfType<NetworkClient>();

        _badNetworkClient.SetPlayerId(_playerUuid);
